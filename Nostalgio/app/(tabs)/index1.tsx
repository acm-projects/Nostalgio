            ...
            renderItem={({ item }) => (
              <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.row}>
                  ...
                  />
                  <Text style={styles.text90}>{item.UserId}</Text>
                  <View style={styles.stat}>
                    <Text style={styles.first}>{item.SpotifyUserId}</Text>
                    <Text style={styles.first}>{item.Email}</Text>
                    <Text style={styles.first}>
                      Trips: <Text style={styles.first}>{item.DisplayName}</Text>
                    </Text>
                    <Text style={styles.last}>Last Visited</Text>
                    <Text style={styles.lastText}>{formatDate(item.Country)}</Text>
                  </View>
                </View>
              </ScrollView>
            )}
